...
document.querySelector("#flip").addEventListener("click", function(){
    //Flip the penny
    console.log('penny flipped!')
    let isHeads = Math.random() > 0.5
    console.log(isHeads)

    if(isHeads) {
        document.querySelector(".penny-img").src = "./assests/images/penny-heads.jpg"
        document.querySelector(".result-header").
        textContent = "You Flipped Heads"
        headsCount++;
    } else {
        document.querySelector(".penny-img").src = "./assests/images/penny-tails.jpg"
        document.querySelector(".result-header").
        textContent = "You Flipped Tails"
        tailsCount++;
    }
})
